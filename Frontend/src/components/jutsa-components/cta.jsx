...
const CtaSection = () => {
  return (
    <section className="w-full  py-10 md:py-20 lg:py-20 bg-gray-100  flex flex-col justify-center items-center text-center">
      <div className="container px-4 md:px-6 text-center">
        <div className="space-y-4">
          <h2 className="text-2xl md:text-5xl font-bold tracking-tighter text-black">
            Join us today
          </h2>
          <p className="mx-auto max-w-[700px] text-lg md:text-lg text-gray-500">
